...
import com.mycompany.myapp.gui.user.UserAdd;
 ...
 * @author momen
 */
public class ArticleShow extends SideMenuBaseForm {
    Form current;
    
    public ArticleShow(user u,Form previous,Resources res) {
        ...
        add(separator);
            ...
            add.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent evt) {
                    new ArticleAdd(current,u).show();
                }
            });
            B.add(add);
            add(B);
        
        for (article  us : ServicesArticles.getInstance().getAllArticles()) {
            Container InfoContainer = new Container(BoxLayout.y());
            Label l = new Label("Project " + us.getId());
            Label date = new Label(us.getNom());
            Label time = new Label(us.getDescription());
            ...
            date.addPointerPressedListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent evt) {
                  ...
                  new ArticleShowOne(current ,us,u, res).show();
